    ...
    >
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
        ...
        <button
          ...
          className="inline-flex min-h-12 items-center justify-center rounded-2xl bg-gradient-to-r from-violet-600 to-blue-600 px-6 text-sm font-black text-white shadow-lg shadow-blue-600/20 transition hover:-translate-y-0.5"
        >
          Open Compare
        </button>
      </div>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 bg-zinc-950/40 backdrop-blur-sm">
          <button
            type="button"
          ...
          />
          <aside className="absolute bottom-0 right-0 max-h-[90vh] w-full overflow-auto rounded-t-[2rem] bg-white p-5 shadow-2xl lg:bottom-auto lg:top-0 lg:h-full lg:max-h-none lg:w-[min(720px,90vw)] lg:rounded-l-[2rem] lg:rounded-tr-none lg:p-8">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                type="button"
                onClick={() => setOpen(false)}
                className="rounded-full border border-zinc-200 px-3 py-1.5 text-sm font-bold text-zinc-700 hover:bg-zinc-50"
              >
                Close
              </button>
            </div>
